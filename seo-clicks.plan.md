# Plan: more clicks on rxflooring.ca

> **Rule:** After finishing any step, update this header and check the box before starting the next step. Do not invent steps that are not listed here.
...
- [x] 3. Sanding & refinishing Ottawa landing
- [x] 4. Tile installation Ottawa landing
- [x] 5. Subfloor prep Ottawa landing
